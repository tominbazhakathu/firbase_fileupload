package com.collegeproject.mysocialmedia.Fragments.myfiles;
...
import com.collegeproject.mysocialmedia.Adapter.MyFilesRecyclerAdapter;
...
public class MyFilesFragment extends Fragment implements HomeFileClickInterface {

    private List<FileDBEntry> dataFromFirebase;
    private RecyclerView recyclerView;
    private MyFilesRecyclerAdapter homeRecyclerAdapter;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        homeRecyclerAdapter = new MyFilesRecyclerAdapter(MyFilesFragment.this, firebaseUser.getUid(), dataFromFirebase);
        ...
        dbReference.child("files").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot filesDataSnapshot : dataSnapshot.getChildren()) {
                    ...
                    if (!file.getUserID().equals(firebaseUser.getUid())) {
                        continue;
                    }
